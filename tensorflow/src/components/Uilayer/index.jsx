...
export default function UiLayer() {
    ...
    useEffect(()=>{
        //加载音效
        sound.add('attackSound', 'https://file.zhengchengshi.top/tensorflow-game-source/attack.mp3');
        sound.add('monsterSound', 'https://file.zhengchengshi.top/tensorflow-game-source/monsterSound.mp3');
        sound.add('jumpSound', 'https://file.zhengchengshi.top/tensorflow-game-source/jumpSound.mp3');
        sound.add('gameoverSound', 'https://file.zhengchengshi.top/tensorflow-game-source/gameoverSound.mp3');
        sound.add('getCoinSound', 'https://file.zhengchengshi.top/tensorflow-game-source/getCoin.mp3');
        ...
        // 创建游戏角色
        const character = [
            {name:"mainBackground", url:"https://file.zhengchengshi.top/tensorflow-game-source/game-background.jpg"},
            {name:"road", url:"https://file.zhengchengshi.top/tensorflow-game-source/ground.png"},
            {name:"coin",url:"https://file.zhengchengshi.top/tensorflow-game-source/coin.png"}
        ];
        ...
        function setup() {
            ...
            let attackAttitudeImages = [
                'https://file.zhengchengshi.top/tensorflow-game-source/attack/1.png',
                'https://file.zhengchengshi.top/tensorflow-game-source/attack/2.png',
                'https://file.zhengchengshi.top/tensorflow-game-source/attack/3.png',
                'https://file.zhengchengshi.top/tensorflow-game-source/attack/4.png',
                'https://file.zhengchengshi.top/tensorflow-game-source/attack/5.png',
                'https://file.zhengchengshi.top/tensorflow-game-source/attack/6.png',
                'https://file.zhengchengshi.top/tensorflow-game-source/attack/7.png',
                'https://file.zhengchengshi.top/tensorflow-game-source/attack/8.png',
                'https://file.zhengchengshi.top/tensorflow-game-source/attack/9.png',
                'https://file.zhengchengshi.top/tensorflow-game-source/attack/10.png',
                'https://file.zhengchengshi.top/tensorflow-game-source/attack/11.png',
                'https://file.zhengchengshi.top/tensorflow-game-source/attack/12.png'
            ...
            let defeatAttitudeImages = [
                'https://file.zhengchengshi.top/tensorflow-game-source/defeat/1.png',
                'https://file.zhengchengshi.top/tensorflow-game-source/defeat/2.png',
                'https://file.zhengchengshi.top/tensorflow-game-source/defeat/3.png',
                'https://file.zhengchengshi.top/tensorflow-game-source/defeat/4.png',
            ...
            // 怪兽姿态
            let dinosaurImages = [
                'https://file.zhengchengshi.top/tensorflow-game-source/monster/1.png',
                'https://file.zhengchengshi.top/tensorflow-game-source/monster/2.png',
                'https://file.zhengchengshi.top/tensorflow-game-source/monster/3.png',
                'https://file.zhengchengshi.top/tensorflow-game-source/monster/4.png',
                'https://file.zhengchengshi.top/tensorflow-game-source/monster/5.png',
                'https://file.zhengchengshi.top/tensorflow-game-source/monster/6.png',
